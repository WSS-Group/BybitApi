 ...
 */
class GetPremiumIndexPriceKline extends Request
{
    /**
    ...
    {
        return '/v5/market/premium-index-price-kline';
    }
    ...
    public function createDtoFromResponse(Response $response): Collection
    {
        return collect($response->json('result.list'))
            ->mapWithKeys(fn (array $data) => [intval(Arr::get($data, 0)) => MarkIndexPriceKline::init($data)]);
    }
}
