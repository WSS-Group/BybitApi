...
it('check if all not implemented tests throw exception', function () {
    ...
    expect(fn () => $asset->getDeliveryRecord())
        ...
        ->and(fn () => $asset->getCoinInfo())
        ->toThrow(NotImplementedYetException::class, "{$commonError}getCoinInfo'.")
        ->and(fn () => $asset->getSubUID())
        ->toThrow(NotImplementedYetException::class, "{$commonError}getSubUID'.")
        ->and(fn () => $asset->getAssetInfo())
        ->toThrow(NotImplementedYetException::class, "{$commonError}getAssetInfo'.")
        ->and(fn () => $asset->getAllCoinsBalance())
        ->toThrow(NotImplementedYetException::class, "{$commonError}getAllCoinsBalance'.")
        ->and(fn () => $asset->getSingleCoinBalance())
        ->toThrow(NotImplementedYetException::class, "{$commonError}getSingleCoinBalance'.")
        ->and(fn () => $asset->getWithdrawableAmount())
        ->toThrow(NotImplementedYetException::class, "{$commonError}getWithdrawableAmount'.")
