...
use BybitApi\Tests\Fixtures\Bybit\Account\GetClassicTransactionLog\OkFixture;
use Illuminate\Support\Carbon;
use Illuminate\Support\Collection;
use Pest\Expectation;
use Saloon\Http\Faking\MockClient;

it('can get logs for classic', function () {
    MockClient::global([
        GetClassicTransactionLog::class => OkFixture::call(),
    ]);

    $result = Account::actingAs($this->defaultActor())->getClassicTransactionLog();
